...
producePath(dataFileIn=open('pathData.txt', "r"), pathFileOut=open('outPath.wf', "w"),
			...
			numericalSteps=3500, timeOffset=1776,  singleCommands={**fadeIn(group='g2', start=1776, maxAlpha=0.99, frameStep=0.8)},
			angleFunction=getEulerAnglesAzimuthElevation, startFrame=0, framesFolder="scene1Frames")
